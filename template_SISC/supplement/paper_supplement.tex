...
\ifpdf
\hypersetup{
  pdftitle={Supplementary Materials: Information geometric regularization of Gas dynamics},
  pdfauthor={Ruijia Cao and Florian Sch{\"a}fer}
}
\fi
